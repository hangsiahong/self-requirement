...
// There mgiht be several variations off these classes.

struct ConcreteComponent {}

impl Component for ConcreteComponent {
    fn operation(&self) -> String {
        String::from("ConcreteComponent".to_string())
    }
}
...
// Concrete Decorators call the wrappd object and alter its result in some way.
...
// This way it can stay independent of the concrete classes of components its work with.
struct Client;
