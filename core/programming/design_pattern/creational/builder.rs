//! Bui/der is a creational design pattern, which allows constructing complex objects step by step.
...
// The Builder trait specifics methods for creating different parts of
// the Product objects.
